...
// Function to download the music from YouTube link
...
// Handling user reply and fetching the selected music
...
const run = async function ({ api, event, args }) {
    ...
    // If the user provided a YouTube link directly
    if (args[0]?.startsWith("https://")) {
        ...
        try {
            ...
            // Fetch and save thumbnails for each search result
...
// Export the module so your bot can use it
